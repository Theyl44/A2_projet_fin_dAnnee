...
<div id="recup_form">
    ...
    if ($verify[0][0] == 0){
        ...
        <th scope='col'>Id du vol</th><th scope='col'>Date</th><th scope='col'>Distance en km</th><th scope='col'>Heure de départ</th><th scope='col'>Heure d'arrivée</th><th scope='col'>Nombre de places restantes</th><th scope='col'>Nom de l'aéroport de départ</th><th scope='col'>Nom de l'aéroport d'arrivée</th><th scope='col'>Code tarifaire</th><th scope='col'>Prix par adulte</th><th scope='col'>Réserver ?</th>
        </tr>";
